...
namespace WebSach.Areas.WebAdmin.Controllers
{
    public class AdminBooksController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Book_Id,Title,Category,Author,Description,Create_at,Update_at,Avatar,View")] Books books)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Book_Id,Title,Category,Author,Description,Create_at,Update_at,Avatar,View")] Books books)
        {
            if (ModelState.IsValid)
            {
